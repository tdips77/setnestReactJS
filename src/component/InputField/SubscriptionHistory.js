            ...
            <div className='row '>
                ...
                <h5>Subscription History</h5> 
                    ...
                    <div className='row'>
                        ...
                        <div className='col-6'>
                        <div className='row pt-0 pb-0 p-3 mb-4 bg-light rounded borderPayment'>
                                  
                                  <div className='col-8 mt-2 mb-2'>
                                  
                                      <div>
                                      <small className='mb-0'><strong>Property 1</strong></small>
                                      <span className='activeBtn'>Active</span>
                                      </div>
                                      <p className='mb-0 fnt-13 w-75'>Lorem Ipsum is simply dummy text of the printing </p>
                                      
                                    </div>
                                    <div className='col-4 text-end mb-2'>
                                    
                                      <small className='mb-0'><strong>Base Yearly Plan</strong></small>
                                      <p className='mb-0'><strong>$ 120</strong></p>
                                    </div>
                                    <hr></hr>
                                    ...
                                    <div className='col-8 d-flex gap-3 mb-3'>
                                      ...
                                      <small className='mb-0'><strong>Next Billing Cycle:</strong></small>
                                      </div>
                                      
                                    </div>
                                    <div className='col-4 text-end mb-3'>
                                    
                                      <small className='mb-0'><strong>Aug 22, 2021</strong></small>
                                      
                                    </div>
                                    <hr></hr>
                                    <div className='col-12 mb-3'>
                                 
                                      <small className='mb-0'><strong>Plan feature Details Summary</strong></small>
                                      <ul>
                                        <li>List 2 Places </li>
                                        <li>Get interaction </li>
                                        <li>All contract document generated</li>
                                      </ul>
