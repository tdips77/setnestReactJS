                      ...
                      <div className='historyBox'>
                        ...
                        <div className='pt-0 pb-0 mb-4'>
                          <div className='cardBody'>
                            <div className='row'>
                              <div className='col-lg-8 col-md-8 col-12 d-flex gap-3'>
                                <Image src={profilePic} alt='profile' className='img-fluid' />
                                <div>
                                  <p className='mb-0'><strong>HDFC Bank</strong></p>
                                  <p className='mb-0 accTxt'>xxxx-xxxx-xxxx-5689</p>
                                </div>
                        ...
                        <h6 className='f600 mb-2'>Previous Transactions</h6>
                        <div className='pt-0 pb-0 mb-4'>
                          <div className='cardBody'>
                            <div className='row'>
                              <div className='col-lg-8 col-md-8 col-12 d-flex gap-3'>
                              ...
                              <div className='col-lg-4 col-md-4 col-12 text-end'>
                                ...
                                <p className='mb-0 redLink'>Download Invoice</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className='historyBox'>
                        <div className='row mb-4 bg-contract rounded'>
                          ...
                          <div className='col-8 d-flex gap-3 mb-3'>
                            ...
                            <div>
                              <p className='mb-0'><strong>Monthly Rent</strong></p>
