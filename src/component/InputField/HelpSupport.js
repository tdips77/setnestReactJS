...
const HelpSupport = () => {
  ...
  return (
    ...
    <div className='container-fluid p-0 propertyDetails'>
                      ...
                      <Accordion defaultActiveKey="0" className='border-0'>
                        <Accordion.Item eventKey="0" className='border-0 mb-3'>
                          ...
                          <Accordion.Body>
                            ...
                            <p className='text-black-50 fnt-13'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desk</p>
                            <p className='mb-0'><strong>Lorem Ipsum </strong></p>
                            <p className='text-black-50 fnt-13'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desk</p>
                            <p className='mb-0'><strong>Lorem Ipsum </strong></p>
                            <p className='text-black-50 fnt-13'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desk</p>
                        ...
                        <Accordion.Item eventKey="1" className='border-0  mb-3'>
                          <Accordion.Header className='faqHead'>Quick links</Accordion.Header>
                          <Accordion.Body>
                        ...
                        <Accordion.Item eventKey="2" className='border-0'>
                          <Accordion.Header className='faqHead'>Billing Question</Accordion.Header>
                          <Accordion.Body>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                            minim veniam, quis nostrud exercitation ullamco laboris nisi ut
