                ...
                <Card.Header as="h5" className='p-4 bg-white'>Contracts</Card.Header>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='mb-3'>
                        ...
                        <div className='row justify-content-center position-relative'>
                            ...
                            <div className='row pt-0 pb-0 p-3 mb-4' onClick={onSubmit}>
                                  ...
                                  <div className='col-12 d-flex '>
                                    ...
                                    <div className='greenClr position-absolute top-0 right10 fnt-13'>
                                    Successful
                                    </div>
                                    </span>
                                </div>
                            ...
                            <Tab eventKey="profile" title="Signed Contracts">
